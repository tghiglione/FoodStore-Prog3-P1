...
export const PRODUCTS: IProduct[] = [
  {
    ...
    stock: 20,
    imagen: "/images/pizza-muzzarella.jpg",
    disponible: true,
  ...
  },
  {
    ...
    stock: 10,
    imagen: "/images/pizza-4-quesos.jpg",
    disponible: true,
    categorias: [categorias[0]],
  },
  {
  ...
  },
  {
    ...
    stock: 25,
    imagen: "/images/hamburguesa-bbq-bacon.jpg",
    disponible: true,
    categorias: [categorias[1]],
  },
  {
    ...
    stock: 0,
    imagen: "/images/hamburguesa-veggie.jpg",
    disponible: false,
    categorias: [categorias[1]],
  },
  {
    ...
    stock: 100,
    imagen: "/images/coca-cola-500ml.jpg",
    disponible: true,
  ...
  },
  {
    ...
    stock: 150,
    imagen: "/images/agua-mineral-500ml.jpg",
    disponible: true,
    categorias: [categorias[2]],
  },
  {
  ...
  },
  {
    ...
    stock: 30,
    imagen: "/images/helado-artesanal.jpg",
    disponible: true,
    categorias: [categorias[3]],
  },
  {
    ...
    stock: 0,
    imagen: "/images/brownie-con-helado.jpg",
    disponible: false,
    categorias: [categorias[3]],
  },
  {
    ...
    stock: 50,
    imagen: "/images/empanadas-de-carne.jpg",
    disponible: true,
  ...
  },
  {
    ...
    stock: 45,
    imagen: "/images/empanadas-de-pollo.jpg",
    disponible: true,
    categorias: [categorias[4]],
  },
  {
    ...
    stock: 60,
    imagen: "/images/empanadas-jamon-y-queso.jpg",
    disponible: true,
    categorias: [categorias[4]],
  },
  {
  ...
  },
  {
    ...
    stock: 18,
    imagen: "/images/ensalada-caprese.jpg",
    disponible: true,
    categorias: [categorias[5]],
  },
  {
    ...
    stock: 10,
    imagen: "/images/pizza-fugazzeta.jpg",
    disponible: true,
    categorias: [categorias[0]],
  },
  {
    ...
    stock: 0,
    imagen: "/images/hamburguesa-crispy-chicken.jpg",
    disponible: false,
    categorias: [categorias[1]],
  },
  {
    ...
    stock: 25,
    imagen: "/images/ensalada-mixta.jpg",
    disponible: true,
    categorias: [categorias[5]],
  },
]
